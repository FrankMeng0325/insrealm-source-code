        ...
        <FadeIn className=" flex items-center xl:flex-row flex-col justify-between gap-4 w-full">
          <div className=' flex items-start justify-center gap-4 flex-col'>
            ...
            <p className="mt-6 text-xl text-neutral-600">
              InsRealm Technology Co., Ltd. specializes in advanced real-time simulation technology. Our core technology originates from the Imperial College London. With nearly a decade of innovation and collaboration with top universities, research institutes, and Fortune 500 companies, we have launched several products that achieve world-leading performance.
            </p>
            <Link href='/about'>
              <Button className=''>
                Learn More
